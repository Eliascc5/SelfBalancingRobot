...
//FALTA LO MISMO PARA INT 1 !!!!!!   PREGUNTAR
/*
#define INT1_evento_nivelBajo (EICRA &=~<<ISC10))
#define INT1_evento_cualquierFlanco (EICRA |=(3<<ISC10))
#define INT1_evento_flancoBajada (EICRA |=4<<ISC10))
#define INT1_evento_flancoSubida (EICRA |=(<<ISC10))
*/
